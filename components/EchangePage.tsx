    ...
    return (
      <div className="max-w-md mx-auto animate-in fade-in zoom-in duration-500">
        <div className="glass p-8 rounded-[2.5rem] border-indigo-500/20 shadow-2xl relative overflow-hidden">
          ...
          <p className="mt-8 text-[10px] text-slate-600 text-center font-bold uppercase tracking-widest italic">Session sécurisée par cryptage 256-bit</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-2xl w-full animate-in fade-in slide-in-from-bottom-10 duration-700">
      <div className="glass p-10 rounded-[3rem] border-white/10 shadow-2xl relative">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
          ...
          <div className="bg-emerald-600/10 border border-emerald-500/20 px-6 py-3 rounded-2xl">
            <span className="text-[10px] font-black text-slate-500 uppercase block mb-1">Solde Profile</span>
            <span className="text-2xl font-black text-white">{currentBalance.toLocaleString()} <span className="text-emerald-400 text-sm">XOF</span></span>
          </div>
        </div>
